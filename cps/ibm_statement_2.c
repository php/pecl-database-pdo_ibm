...
SQLRETURN _php_db2_override_SQLBindParameter (
	SQLHSTMT hstmt,                
	SQLSMALLINT ipar,                      
...
#define SQLBindParameter(p1,p2,p3,p4,p5,p6,p7,p8,p9,p10) _php_db2_override_SQLBindParameter(p1,p2,p3,p4,p5,p6,p7,p8,p9,p10)
#endif /* PASE */
			...
			if (Z_TYPE_P(curr->parameter) == IS_NULL
				...
				*/
				...
				if (inputOutputType != SQL_PARAM_INPUT &&
					...
					Z_STR_P(parameter) = zend_string_extend(Z_STRVAL_P(parameter), curr->max_value_len + 1, 0);
					/* Z_PTR_P(parameter) =  erealloc(Z_STRVAL_P(parameter), curr->max_value_len + 1); */
